...
if __name__ == '__main__':
    ...
    target = wg.render_polylines(
        (width, height),
        mvp = mvp,
        polylines = [ wg.cubic_basis_spline(points, knots=len(points) * 50) ],
    ...
    shape_optimizer = wg.ReparamVectorAdam(
        points = points,
    ...
    width_optimizer = Adam(params=[stroke_width], lr=1e-1)
